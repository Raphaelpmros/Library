...
const LoginUser = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await loginUser(formData, config);
            const data = response;
            ...
            <div className="flex items-center justify-center" style={{ height: "70vh" }} >
                <div className="w-full max-w-lg p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700" >
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button className="w-full bg-gray-800 text-white hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" disabled={isSubmitting} >
